...
cf_model_mlp    = {'path': "models/mlp_room_prediction.h5"}
cf_model_knn    = {'path': "models/knn_room_prediction.h5"}
cf_model_randf  = {'path': "models/randf_room_prediction.h5"}
cf_model_mlinear= {'path': "models/mlinear_room_prediction.h5"}
